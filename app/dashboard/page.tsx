...
export default async function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(251,191,36,0.08),transparent_22%),linear-gradient(to_bottom,#f8fafc,#eef2ff_55%,#f8fafc)] px-4 py-10">
      <div className="mx-auto max-w-6xl space-y-8">
        <section className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_20px_60px_rgba(15,23,42,0.08)]">
          <div className="border-b border-slate-200 bg-[linear-gradient(135deg,rgba(15,23,42,0.98),rgba(30,41,59,0.94),rgba(30,64,175,0.92))] px-8 py-10 text-white">
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-3xl">
                ...
                <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-200 sm:text-base">
                  ...
                  atalhos rápidos para navegar pela plataforma do Professor Kaue
                  Ribeiro com mais clareza.
                </p>
              </div>

              <div className="grid gap-3 sm:grid-cols-2 lg:min-w-[300px] lg:max-w-[340px] lg:grid-cols-1">
          ...
          <div className="grid gap-4 px-6 py-6 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-50/80 p-5">
              <p className="text-sm font-medium text-slate-500">Acesso rápido</p>
              <p className="mt-2 text-lg font-semibold text-slate-900">
                {authData.role === "admin" ? "Painel administrativo" : "Área do aluno"}
              </p>
              <p className="mt-2 text-sm text-slate-500">
        ...
        <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          ...
          >
            ...
            <p className="mt-3 text-sm leading-6 text-slate-600">
              Veja conteúdos publicados e organize seu estudo com mais facilidade.
            </p>
            <span className="mt-5 inline-flex text-sm font-semibold text-slate-900 transition group-hover:translate-x-1">
              Ver materiais →
            </span>
          ...
          >
            ...
            <p className="mt-3 text-sm leading-6 text-slate-600">
              Acompanhe status, datas e detalhes dos seus pedidos mais recentes.
            </p>
            <span className="mt-5 inline-flex text-sm font-semibold text-slate-900 transition group-hover:translate-x-1">
              Ver agendamentos →
            </span>
          ...
          {authData.role === "admin" ? (
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Gerencie materiais, agendamentos e o funcionamento da plataforma.
              </p>
              <span className="mt-5 inline-flex text-sm font-semibold text-slate-900 transition group-hover:translate-x-1">
                Ir para o painel →
              </span>
            ...
            <div className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Mantenha seus estudos em dia usando os materiais publicados e os
            ...
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Seus pedidos mais recentes em um formato mais claro e fácil de
                  acompanhar.
                </p>
              </div>
                        ...
                        <div className="mt-4 grid gap-3 sm:grid-cols-2">
                          <div className="rounded-2xl bg-slate-50 px-4 py-3">
                            ...
                            <p className="mt-1 text-sm font-medium text-slate-700">
                              {getBookingLevel(booking) || "Nível não informado"}
                            </p>
                          </div>
                          ...
                          <div className="rounded-2xl bg-slate-50 px-4 py-3">
                            ...
                            <p className="mt-1 text-sm font-medium text-slate-700">
                              {getBookingDateTime(booking) || "Data não informada"}
                            </p>
                          </div>
                        </div>
                      </div>
          ...
          <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Os últimos conteúdos liberados para você continuar estudando.
                </p>
              </div>
            ...
            {!materials || materials.length === 0 ? (
              <div className="rounded-3xl border border-dashed border-slate-300 bg-slate-50 px-6 py-12 text-center">
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Quando novos materiais forem publicados, eles aparecerão aqui.
                </p>
              </div>
            ) : (
              <div className="space-y-4">
