          ...
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-[#dbe6f5] bg-white px-5 py-4 shadow-sm">
                  ...
                  <p className="mt-2 text-[#183A7A]">
                    Aulas pelo Google Meet com praticidade e acompanhamento
                    próximo.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-[#dbe6f5] bg-white px-5 py-4 shadow-sm">
                  ...
                  <p className="mt-2 text-[#183A7A]">
                    Atendimento em Goiânia/GO para quem prefere um formato mais
                    direto.
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-[28px] border border-[#dbe6f5] bg-white p-8 shadow-[0_18px_45px_rgba(24,58,122,0.08)]">
              ...
              <p className="mt-4 leading-7 text-[#42526e]">
                Entre em contato para alinhar disciplina, formato da aula e
                horários mais adequados para a rotina do aluno.
              </p>
